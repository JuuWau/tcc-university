            ...
            <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; max-width: 600px;">
                ...
                <tr>
                    <td style="background-color: #ffffff; border: 1px solid #e2e8f0; padding: 40px;">
                        <h1 style="margin: 0 0 24px; color: #0f172a; font-size: 24px; line-height: 32px;">Bem-vindo(a)!</h1>
                        <p style="margin: 0 0 16px; font-size: 16px; line-height: 24px;">Você foi convidado para acessar o sistema{{ $isStaff ? ' como colaborador' : '' }}.</p>
                        <p style="margin: 0 0 28px; font-size: 16px; line-height: 24px;">Para criar sua senha e ativar sua conta, clique no botão abaixo.</p>
                        <table cellpadding="0" cellspacing="0" role="presentation" style="margin: 0 auto 28px;">
                            <tr>
                                <td style="border-radius: 8px; background-color: #0284c7;">
                                    <a href="{{ $url }}" target="_blank" rel="noopener" style="display: inline-block; padding: 14px 24px; color: #ffffff; font-size: 15px; font-weight: bold; line-height: 20px; text-decoration: none;">Completar meu cadastro</a>
                                </td>
                            </tr>
                        </table>
                        <p style="margin: 0 0 24px; font-size: 14px; line-height: 22px;">Se você não esperava este convite, ignore este email.</p>
