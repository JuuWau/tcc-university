...
import ClinicsReportFilters from './components/ClinicsReportFilters.vue';
import ClinicsReportSummaryCards from './components/ClinicsReportSummaryCards.vue';
import ClinicsReportTable from './ClinicsReportTable.vue';
...
const clinics = useClinicsReport();

provide(ClinicsReportKey, clinics);

const showFilters = ref(false);

const hasActiveFilters = computed(() => {
    const filters = clinics.filters.value;
...
<template>
    <AppLayout>
        <div class="space-y-6 p-6">
            ...
            >
                <PageHeader
                    title="Relatório de Clínicas"
                    description="Consulte e analise as clínicas e seus horários cadastrados."
                >
                    <template #actions>
                        <ExportExcelButton
                            @click="clinics.exportExcel()"
                        />
                    </template>
                </PageHeader>
            </div>
            ...
            >
                ...
                >
                    ...
                    >
                        <ClinicsReportFilters />
                    </div>
                </Transition>
            </div>

            <ClinicsReportSummaryCards />
